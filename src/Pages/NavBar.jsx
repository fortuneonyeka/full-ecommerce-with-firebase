    ...
    <>
      <nav className="flex items-center justify-between flex-wrap bg-teal-500 p-6">
        <div className="flex items-center flex-shrink-0 text-white mr-6">
          ...
          <span className="font-semibold text-xl tracking-tight">Firbase</span>
        </div>
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto ps-5">
          <div className="text-sm lg:flex-grow">
            <NavLink
              to="/"
              className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 text-white mr-4 text-4xl no-underline"
            >
              Home
            </NavLink>
            <NavLink
            ...
            <NavLink
              to="/contact"
              className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 text-white hover:text-blue-300 text-4xl no-underline"
            >
              Contact Us
            </NavLink>
          </div>
